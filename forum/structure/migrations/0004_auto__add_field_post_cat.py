...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Post.cat'
        db.add_column(u'structure_post', 'cat',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['structure.SubCategory'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Post.cat'
        db.delete_column(u'structure_post', 'cat_id')
    ...
    models = {
        ...
        u'structure.post': {
            ...
            'cat': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['structure.SubCategory']", 'null': 'True', 'blank': 'True'}),
        ...
        u'structure.postcount': {
            'Meta': {'object_name': 'PostCount'},
