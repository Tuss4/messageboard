...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'profiles_profile', (
            ...
            ('age', self.gf('django.db.models.fields.CharField')(max_length=2, null=True, blank=True)),
            ('gender', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['profiles.Gender'], null=True, blank=True)),
        ...
        # Adding model 'Gender'
        db.create_table(u'profiles_gender', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('sexe', self.gf('django.db.models.fields.CharField')(max_length=140)),
        ))
        db.send_create_signal(u'profiles', ['Gender'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'profiles_gender')
    ...
    models = {
        ...
        u'profiles.gender': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'sexe': ('django.db.models.fields.CharField', [], {'max_length': '140'})
        },
        u'profiles.profile': {
            'Meta': {'ordering': "['member']", 'object_name': 'Profile'},
            'about': ('django.db.models.fields.TextField', [], {}),
            'age': ('django.db.models.fields.CharField', [], {'max_length': '2', 'null': 'True', 'blank': 'True'}),
            'gender': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['profiles.Gender']", 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
